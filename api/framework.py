...
class QpytUI:
    ...
    def __init__(self, title: str = "Qpyt-UI App"):
        ...
        self.available_library: List[Dict[str, Any]] = [
            ...
            {"id": "qp-llm-assistant", "label": "LLM Assistant (Ollama/Gemini)", "type": "input", "icon": "chat-left-dots"},
            ...
            {"id": "qp-grid-explore", "label": "Grid Explorer", "type": "generator", "icon": "layers-half"},
            {"id": "qp-auto-background", "label": "Smart Background", "type": "generator", "icon": "image-fill"},
            {"id": "qp-narrator", "label": "Story Narrator", "type": "input", "icon": "book"},
